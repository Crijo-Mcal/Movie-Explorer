...
export default function Card({ movie, setImgbgUrl, type }) {
  ...
  return (
    <motion.div
      className="w-45  h-87 gap-2 bg-bg2 flex flex-col items-center shadow-type1 rounded-b-xl cursor-pointer"
    ...
    >
      {movie.poster_path ? (
        <img
          ...
          alt={movie.title}
          className="w-38.5 mt-2 rounded-lg"
        />
      ) : (
        <div className="w-38.5 h-57.75  mt-2 rounded-lg flex justify-center items-center">

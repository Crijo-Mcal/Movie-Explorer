...
export default function Hero() {
  return (
    <section
      className="relative w-full  max-w-[1228px] sm:mt-4 min-h-[267px] bg-bg2  flex flex-col  justify-center items-center bg-cover bg-top "
      style={{
    ...
    >
      ...
      <div className="z-5 px-8 h-auto min-w-[200px] ">
